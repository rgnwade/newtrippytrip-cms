                                    ...
                                    <table class="table text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ url('') }}/assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                            ...
                                            <ul class="media-list content-group">
                                                <li class="media stack-media-on-mobile">
                                                    <div class="media-left">
                                                        <div class="thumb">
                                                            <a href="#">
                                                                <img src="{{ url('') }}/assets/images/placeholder.jpg" class="img-responsive img-rounded media-preview" alt="">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active fade in has-padding" id="messages-tue">
                                        <ul class="media-list">
                                            <li class="media">
                                                <div class="media-left">
                                                    <img src="{{ url('') }}/assets/images/placeholder.jpg" class="img-circle img-xs" alt="">
