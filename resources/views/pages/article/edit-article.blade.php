     ...
     <div class="col-md-4">
      ...
      {{-- <div class="col-md-4">
            ...
            <input type="file" name="thumbnail_pict" id="thumbnail_pict"  onchange="readURL(this);" accept="image/*" class="form-control">
              @foreach($article as $index=>$key)
               <img id="blah" name="thumbnail_pict" src="{{ $key->thumbnail_pict }}" alt="add your image" />
               @endforeach
            <br>
            <br>
            ...
            <label>Link Iframe Video</label>
              @foreach($article as $index=>$key)
            <input type="text" name="video" id="video" class="form-control" value="{{ $key->video }}">
               @endforeach
            <br>
            <br>
            ...
            <label>Description</label>
              @foreach($article as $index=>$key)
            <textarea  name="description" class="form-control" id="description"  maxlength="200" rows="4" value="{{ $key->description }}">
            </textarea>
            @endforeach
