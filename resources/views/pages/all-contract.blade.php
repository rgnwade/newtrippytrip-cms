			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">All Contract</span></h4>
						</div>

						<div class="heading-elements">
							<div class="heading-btn-group">
                	<button type="button" class="btn bg-blue" data-toggle="modal" data-target="#modal-registration"><i class="icon-pencil3 position-left"></i>Add Contract</button>
							</div>
						</div>
					</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="datatable_basic.html">All Contract</a></li>
						</ul>
					</div>
				</div>
				<!-- /page header -->
				...
				<div class="content">
                  ...
                  <th>Status</th>
							...
							<tbody>
                @foreach($contract as $index=>$key)
								<tr>
									<td>{{ $key->id }}</td>
									<td><a href="#">{{ $key->contract_number }}</a></td>
									<td>{{ $key->client[0]->name }}</td>
									<td>{{ $key->author[0]->name }}</td>
                  <td>{{ $key->expired }}</td>
